  ...
  return (
    <>
      <div className="w-3/4 grid grid-flow-row-dense grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-10">
        <div className="video flex flex-grow bg-blue-300 h-36 sm:col-span-2 md:col-span-3">1</div>
        <div className="video flex flex-grow bg-red-200 h-36 md:col-span-2">Blog Thumbnail</div>
        <div className="video flex flex-grow bg-green-400 h-36">Blog Thumbnail</div>
        ...
        <div className="video flex flex-grow bg-blue-400 h-36">Blog Thumbnail</div>
        <div className="video flex flex-grow bg-green-400 h-36">Blog Thumbnail</div>
