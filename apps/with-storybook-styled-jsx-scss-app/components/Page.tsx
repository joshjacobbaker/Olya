  ...
  <>
    <article>
      ...
      <section>
        ...
        <p>This example shows Styled-jsx (with SCSS) working for components rendered both inside and outside of Storybook.</p>
        ...
        <p>Additionally, the Storybook demo components are moved into the components directory and their css is refactored into component level Styled JSX + SCSS.</p>
        <p>Story files live in their own directory and refer to the components within /components.</p>
        <p>The /styles directory contains styles, both global and for the index.js file.</p>
        <p>
